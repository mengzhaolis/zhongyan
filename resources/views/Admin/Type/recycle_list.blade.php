			...
			<tbody>
				@foreach($data as $v)
					<tr class="text-c">
						...
						<a title="还原" href="javascript:;" onclick="system_category_edit(this,{{$v['id']}})" style="text-decoration:none"><i class="Hui-iconfont">&#xe6f7;</i></a>
					...
					@foreach($v['son'] as $val)
						...
						<a title="还原" href="javascript:;" onclick="system_category_edit(this,{{$val['id']}})" style="text-decoration:none"><i class="Hui-iconfont">&#xe6f7;</i></a>
						...
						@foreach($val['son'] as $value)
							...
							<a title="还原" href="javascript:;" onclick="system_category_edit(this,{{$value['id']}})" style="text-decoration:none"><i class="Hui-iconfont">&#xe6f7;</i></a>
...
function system_category_edit(obj,id,){
	layer.confirm('确认要还原吗？',function(index){
		var token = $("#token").val();
		$.ajax({
			type: 'POST',
			url: '/type/type_list_recycle',
