...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="product_add('添加视频','{{url('/video/video_add')}}')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加视频</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<div class="mt-20">
			...
			<tbody>
				@foreach($data as $val)
					<tr class="text-c">
						...
						@endif
						<a style="text-decoration:none" class="ml-5" href="{{url('/case/case_up')}}?id={{$val->id}}" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> 
