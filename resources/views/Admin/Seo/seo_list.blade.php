...
<div class="page-container">
    ...
    <a class="btn btn-primary radius" onclick="modaldemo()" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加seo分类</a>
			...
			<tbody>
                @foreach($data as $val)
                    <tr class="text-c">
                        ...
                        <td>{{$val->id}}</td>
                        <td><a href="/seo/seo_data_list?id={{$val->id}}">{{$val->title}}</a></td>
        ...
        <div class="modal-dialog">
            <div class="modal-content radius">
                <div class="modal-header">
                    <h3 class="modal-title">添加seo分类</h3>
                    <a class="close" data-dismiss="modal" aria-hidden="true" href="javascript:void();">×</a>
                </div>
                <div class="modal-body">
                    <div class="row cl">
                        <label class="form-label col-xs-4 col-sm-2" style="width:100px;">分类名称：</label>
                        <div class="formControls col-xs-8 col-sm-9">
                            <input type="text" class="input-text" value="0" placeholder="" id="title" name="img_type_name">
            ...
            <div class="modal-content radius">
                ...
                <div class="modal-body">
                    <div class="row cl">
                        <label class="form-label col-xs-4 col-sm-2" style="width:100px;">分类名称：</label>
                        <div class="formControls col-xs-8 col-sm-9">
                            <input type="text" class="input-text" value="0" placeholder="" id="titles" name="img_type_name">
                            <input type="hidden" id="token" value="{{csrf_token()}}">
...
$("#img_add").click(function(){
    ...
    var url = "/seo/seo_add";
    var data = {'_token':token,'title':title};
...
$("#seo_add").click(function(){
    ...
    var url = "/seo/seo_type_update";
    var data = {'_token':token,'title':title,'id':id};
    $.post(url,data,function(data){
        if(data !='')
		{
			layer.msg('添加成功!',{icon:1,time:1000});
