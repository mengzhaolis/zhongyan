    ...
    {{csrf_field()}}
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{$data->course_title}}" placeholder="" id="" name="course_title">
			</div>
		</div>
		<!-- <div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="course_type" class="select">
					...
					<option value="总裁公开课">总裁公开课</option>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">课程时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="demo-input" name="created_at" placeholder="请选择课程开始日期" id="test1" value="{{$data->created_at}}">
		    -
		    <input type="text" class="demo-input" name="updated_at" placeholder="请选择课程结束日期" id="test1" value="{{$data->updated_at}}">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">是否需要注册：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="radio" id="sex-2" name="sex" value="1" checked>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="course_jian" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)">{{$data->course_jian}}</textarea>
				<p class="textarea-numberbar"><em class="textarea-length">0</em>/200</p>
			</div>
		</div>
		<div class="row cl">
...
<script type="text/javascript" src="/H-ui.admin/laydate.js"> </script>
