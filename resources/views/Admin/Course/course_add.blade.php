    ...
    {{csrf_field()}}
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="course_title">
			</div>
		</div>
		<!-- <div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="demo-input" name="created_at" placeholder="请选择课程开始日期" id="test1">
		    -
		    <input type="text" class="demo-input" name="updated_at" placeholder="请选择课程结束日期" id="test1">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="seo_title" id="" placeholder="多个关键字用英文逗号隔开，限10个关键字" value="" class="input-text">
			</div>
		</div>
		<div class="row cl">
