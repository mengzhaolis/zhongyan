...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 总裁专享 <span class="c-gray en">&gt;</span> 资讯列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a class="btn btn-primary radius" onclick="product_add('添加资讯','{{url('/supremo/add')}}')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加资讯</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<div class="mt-20">
			...
			<tbody>
				@foreach($data as $val)
					<tr class="text-c">
						...
						@endif
						<a style="text-decoration:none" class="ml-5" href="{{url('/supremo/supremo_up')}}?id={{$val->id}}" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> 
	...
	layer.confirm('确认要置顶吗？',function(index){
		$.ajax({
			...
			success: function(data){
				...
				layer.msg('置顶成功!',{icon: 1,time:1500});
				// $(obj).parents("tr").find(".td-manage").prepend('<a style="text-decoration:none" onClick="article_stop(this,{{$val->id}})" href="javascript:;" title="取消置顶"><i class="Hui-iconfont">&#xe6de;</i></a>');
	...
	layer.confirm('确认要取消吗？',function(index){
		$.ajax({
			...
			success: function(data){
				...
				layer.msg('取消置顶!',{icon: 1,time:1500});
