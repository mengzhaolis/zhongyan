    ...
    <div id="tab-category" class="HuiTab">
			...
			<div class="tabCon">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" id="juris" value="" style="width:200px;">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" id="juris_url" value="">
					</div>
					<div class="col-3">
					</div>
				</div>
...
$("#tijiao").click(function(){
    ...
    if(type==1)
    {
        ...
        var data ={'_token':token,'juris_name':juris,'juris_url':juris_url}
